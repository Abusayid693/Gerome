  ...
  return (
    <div className="border-2 border-slate-300 rounded max-w-lg display-block m-auto p-4">
      ...
      <div className="pt-5">
        ...
        <button className="bg-blue-800 w-full py-3 rounded text-white">Sign In</button>
        ...
        <Link href={'/signup'}>
          <button className="w-full py-3 rounded text-blue-800 border border-blue-800">Sign Up</button>
        </Link>
      </div>
    </div>
  );
